"""Focused tests for the Qwen backward-lineage and fresh-start proof lane backward-lineage probe
helpers.

Purpose:
    Keep the backward-lineage probe honest by locking the requested branch order and the
...
def test_case_specs_follow_requested_loss_order_before_row_isolation() -> None:
    """backward-lineage must probe pair branches before any row-isolation cases."""
