...
- `pdm run run-hemma -- pdm run python -m scripts.sir_convert_a_lot.devops.run_hemma_resource_monitor launch --output-root /srv/scratch/sir-convert-a-lot/build/verification/task-309-granite-answer-key-live/resource-monitor --runtime-kind rocm --interval-seconds 10 --duration-seconds 3600`
...
- `pdm run run-hemma -- pdm run python -m scripts.sir_convert_a_lot.devops.run_hemma_resource_monitor stop --output-root /srv/scratch/sir-convert-a-lot/build/verification/task-309-granite-answer-key-live/resource-monitor`
