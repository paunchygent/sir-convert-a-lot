...
- `pdm run ruff format tests/sir_convert_a_lot/test_run_hemma_wrapper.py tests/sir_convert_a_lot/test_verify_hemma_gpu_runtime_wrapper.py`
- `pdm run ruff check tests/sir_convert_a_lot/test_run_hemma_wrapper.py tests/sir_convert_a_lot/test_verify_hemma_gpu_runtime_wrapper.py`
- `pdm run pytest-root tests/sir_convert_a_lot/test_run_hemma_wrapper.py tests/sir_convert_a_lot/test_verify_hemma_gpu_runtime_wrapper.py -q`
