...
- [ ] `S01` `docs/backlog/stories/story-14-v2-only-clean-break-and-api-surface-unification.md`
  (requires `T04-T05`)
- [ ] `S02` `docs/backlog/stories/story-13-docx-template-catalog-and-reference-governance.md`
  (requires `T06-T07`)
...
- Tasks must be executed and checked off in numeric order.
...
- [ ] `T01` `docs/backlog/tasks/task-59-enforce-90-percent-test-coverage-gate-for-conversion-core.md`
...
- [ ] `T04` `docs/backlog/tasks/task-44-remove-v1-api-cli-clients-and-contracts-clean-break-to-v2.md`
- [ ] `T05` `docs/backlog/tasks/task-45-unify-route-registry-on-v2-and-manifest-contract-hardening.md`
- [ ] `T06` `docs/backlog/tasks/task-46-design-docx-template-contract-storage-and-selection-model.md`
- [ ] `T07` `docs/backlog/tasks/task-47-implement-docx-template-endpoints-validation-and-fixture-templates.md`
- [ ] `T08` `docs/backlog/tasks/task-48-add-v2-route-docx-to-md-with-deterministic-normalization.md`
