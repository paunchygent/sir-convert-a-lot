...
links:
  decisions: []
outcome: Exam artifact conversion and authoring to Exam.net-compatible targets
retired_ids:
- epic-10-digiexam-to-exam-net-exam-migration-pipeline
---
...
- Characterize DigiExam artifact and item-type evidence in
  `docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md`, with
  renderer/import research kept in
  `docs/reference/ref-sircon-research-digiexam-jspdf-export-shape-and-exam-net-migration-research-digiexam-jspdf-export-shape-and-exam-net-migration-research.md`.
...
1. `docs/backlog/stories/st-sircon-07-01-exam-net-artifact-authoring-bundle-for-qti-and-editable-docx.md`
...
1. Completed Task 280 for deterministic QTI sample packages and
   ...
   runtime exposure.
1. `docs/backlog/stories/st-sircon-07-02-service-source-simplification-and-active-surface-truth-cleanup-before-exam-net-runtime.md`
...
1. `docs/backlog/stories/st-sircon-07-03-solid-domain-coupling-audit-for-exam-converter-implementation-boundaries.md`
...
1. `docs/backlog/epics/epic-sircon-08-machine-marked-answer-key-completion-for-exam-conversion.md`
...
- DigiExam artifact containment and absence claims must stay linked to the
  evidence files in
  `docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md`; do not
...
- Task 278 completed on 2026-05-11 with
  `docs/reference/ref-sircon-general-digiexam-migration-service-api-artifact-contract-digiexam-migration-service-api-artifact-contract.md` as the
...
- The canonical Swedish Exam.net PDF-to-exam renderer profile is now recorded
  in `docs/reference/ref-sircon-general-exam-net-pdf-to-exam-swedish-renderer-profile-exam-net-pdf-to-exam-swedish-renderer-profile.md`.
...
- The promoted Exam.net PDF-converter schemas are recorded in
  ...
  `docs/reference/ref-sircon-general-exam-net-pdf-to-exam-swedish-renderer-profile-exam-net-pdf-to-exam-swedish-renderer-profile.md` owns the
