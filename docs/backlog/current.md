...
- Task 185 follow-on: keep the `1236` eval baseline as the historical reference point, relaunch the preserved pilot lane from the newer compatible `1238` checkpoint, and append live progress in `docs/reference/ref-task101-training-eval-pilot-progress-2026-03-15.md`.
