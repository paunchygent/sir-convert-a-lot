...
- Current training follow-on is `T117` for graceful stop, cold-start visibility, and cache-sync hardening now that `T142` has established the corrected Task 101 pilot input contract.
