...
1. `convert-a-lot` usage docs exist with canonical examples for local tunnel workflow.
1. Batch run emits deterministic manifest containing:
...
1. All API failures follow standard error envelope with canonical error codes.
