...
- `docs/**/INDEX.md`: generated lane indexes maintained by `docs-sync`.
- `docs/_meta/`: docs-as-code contract metadata.
- `.codex/rules/`: operational rules and conventions.
- `.codex/handoff.md`: volatile session handoff and active planning pointer.
...
- `pdm run docs-sync` regenerates docs index surfaces before validation.
