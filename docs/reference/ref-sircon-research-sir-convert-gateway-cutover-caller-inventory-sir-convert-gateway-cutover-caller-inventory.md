...
| HuleEdu Gateway                           | product/browser public entry     | `/sir-convert/v2/convert/...` Gateway route family                                                 | HuleEdu browser session + CSRF                           | Gateway routes sign `InternalIdentityContextV1` with audience `sir-convert-a-lot`                                                         | Generic conversion ingress remains governed by the HuleEdu Gateway contract. |
