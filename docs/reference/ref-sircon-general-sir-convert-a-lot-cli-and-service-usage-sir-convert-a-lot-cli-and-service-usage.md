---
type: reference
id: REF-SIRCON-GENERAL-sir-convert-a-lot-cli-and-service-usage
...
- Normative API: `docs/reference/ref-sircon-general-multi-format-conversion-service-api-v2-multi-format-conversion-service-api-v2.md`
