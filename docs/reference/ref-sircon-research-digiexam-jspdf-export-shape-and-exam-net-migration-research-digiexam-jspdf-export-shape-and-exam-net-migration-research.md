---
type: reference
id: REF-SIRCON-RESEARCH-digiexam-jspdf-export-shape-and-exam-net-migration-research
...
retired_ids:
- REF-digiexam-jspdf-export-shape-and-examnet-migration-research
summary: DigiExam jsPDF Export Shape And Exam.net Migration Research
---
...
does not contain is
`docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md`.
...
in `docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md`:
...
`docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md` owns the
...
Use
`docs/reference/ref-sircon-general-exam-net-pdf-to-exam-swedish-renderer-profile-exam-net-pdf-to-exam-swedish-renderer-profile.md` as the
...
labels only through
`docs/reference/ref-sircon-general-exam-net-pdf-to-exam-swedish-renderer-profile-exam-net-pdf-to-exam-swedish-renderer-profile.md` and fresh
...
- Artifact and item-type containment claims belong in
  `docs/reference/ref-sircon-research-digiexam-exam-artifact-item-type-evidence-digiexam-exam-artifact-item-type-evidence.md`; this
