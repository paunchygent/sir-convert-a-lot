---
type: reference
id: REF-SIRCON-GENERAL-examauthoringir-v1-contract
...
retired_ids:
- CONV-exam-authoring-ir-v1-contract
summary: ExamAuthoringIR v1 Contract
---
## Overview

Source record: docs/converters/exam-authoring-ir-v1-contract.md
...
> `docs/reference/ref-sircon-general-exam-authoring-corrections-apply-contract-exam-authoring-corrections-apply-contract.md`. It defines
