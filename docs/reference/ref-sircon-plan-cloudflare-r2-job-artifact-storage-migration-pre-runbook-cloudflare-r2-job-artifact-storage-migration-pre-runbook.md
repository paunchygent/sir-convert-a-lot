...
events, idempotency state, `.manifest.lock` files, active scratch/work directories, partial artifacts, checkpoints, logs, and correction replay artifact sets on the existing POSIX job store.
