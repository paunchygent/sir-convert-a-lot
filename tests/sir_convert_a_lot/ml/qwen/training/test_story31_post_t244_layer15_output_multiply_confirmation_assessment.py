"""Focused tests for the T245 Story 31 multiply-site confirmation assessment.

Purpose:
    Lock the post-T244 causal-confirmation contract so Story 31 can test the
    winner-specific layer-15 `output_scale=0.5` multiply without reopening a
    broad stabilizer family.

Relationships:
    - Exercises `story31_post_t244_layer15_output_multiply_confirmation_assessment.py`.
...
from scripts.sir_convert_a_lot.ml.qwen.training import (
    story31_post_t244_layer15_output_multiply_confirmation_assessment as t245_assessment,
)
...
_BUILD_ASSESSMENT = t245_assessment.build_post_t244_layer15_output_multiply_confirmation_assessment


def test_build_post_t244_layer15_output_multiply_confirmation_marks_confirmed() -> None:
    ...
    assert assessment == Story31PostT244Layer15OutputMultiplyConfirmationAssessment(
        stabilization_variant=_T245_VARIANT,
...
def test_build_post_t244_layer15_output_multiply_confirmation_marks_not_causal() -> None:
...
def test_build_post_t244_layer15_output_multiply_confirmation_marks_regression() -> None:
...
def _settings() -> Story31StabilityLabSettings:
    return Story31StabilityLabSettings(
        ...
        stabilization_variants=(_T245_VARIANT,),
        build_image=False,
    )
