"""Tests for the detached Story 29 fallback standalone eval helper."""
...
def test_launch_injects_eval_output_dir_when_missing(
    ...
    monkeypatch.setattr(
        "scripts.sir_convert_a_lot.ml.qwen.training.story29_fallback_eval_detached.subprocess.Popen",
        fake_popen,
    )
    ...
    launch = launch_detached_story29_eval(
        ...
        eval_args=[
            ...
            "--launch-root",
            "/srv/scratch/sir-convert-a-lot/build/verification/qwen3-tts-swedish-hemma-training/task198-fallback1470",
        ],
