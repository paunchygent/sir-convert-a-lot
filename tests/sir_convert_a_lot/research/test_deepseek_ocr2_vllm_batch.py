"""Tests for the specialist OCR command adapter DeepSeek-OCR-2 vLLM batch command adapter.
...
Relationships:
    Exercises `scripts.sir_convert_a_lot.devops.deepseek_ocr2_vllm_batch`
    as the DeepSeek batch command invoked by formula candidate evaluation.
"""
...
def test_inner_runner_uses_official_deepseek_vllm_model_registration() -> None:
    ...
    compile(source, "deepseek-ocr2_deepseek_ocr2_vllm_inner.py", "exec")
