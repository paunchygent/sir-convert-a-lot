...
Relationships:
    ...
    - Uses checked-in PDF fixtures via `tests.sir_convert_a_lot.conversion.pdf_fixtures`.
"""
...
from tests.sir_convert_a_lot.research.scientific_corpus_harness_fakes import (
