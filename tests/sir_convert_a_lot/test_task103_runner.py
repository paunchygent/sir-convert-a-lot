"""Task 103 runner and orchestration tests.

Purpose:
    Cover the public Task 103 CLI, run-root orchestration, and source-selection
    coordination behavior without mixing in lower-level source-adapter or ASR
    implementation details.

Relationships:
    - Tests `run_task103_qwen_swedish_preprocessing`.
