"""Tests for formula candidate evaluation formula candidate evaluation.

Purpose:
    Prove the formula candidate evaluation evaluation harness extracts established replay formula
    regions, records candidate blockers, and produces reviewable local reports.

Relationships:
    Exercises `scripts.sir_convert_a_lot.devops.formula_candidate_eval`
...
from scripts.sir_convert_a_lot.devops.formula_candidate_eval import (
    BAD_MARKERS,
    CandidateSpec,
    SourceInput,
...
def test_marker_counts_include_failure_markers() -> None:
