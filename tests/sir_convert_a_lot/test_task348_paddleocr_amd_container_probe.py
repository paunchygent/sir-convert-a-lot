"""Tests for the Task 348 native AMD PaddleOCR container probe.
...
Relationships:
    Exercises `scripts.sir_convert_a_lot.devops.task348_paddleocr_amd_container_probe`
    as the runtime-inventory and formula-recognition smoke surface for Task 348.
"""
...
from scripts.sir_convert_a_lot.devops.task348_paddleocr_amd_container_probe import (
    DEFAULT_IMAGE,
...
def test_inner_probe_collects_runtime_and_formula_api_without_shims() -> None:
    ...
    compile(source, "task348_paddleocr_amd_inner_probe.py", "exec")
