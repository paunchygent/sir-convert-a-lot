...
1. Keep API docs (`docs/converters/`), ADRs (`docs/decisions/`), runbooks (`docs/runbooks/`),
   references (`docs/reference/`), and PDRs (`docs/pdr/`) aligned with code and intent.
1. Update `docs/backlog/current.md` and `.agents/work/session/handoff.md` after major phases.
