"""Runtime helpers for Hemma-hosted Qwen corpus acquisition.
...
Relationships:
    - Used by `cli.ml.qwen_acquire`.
    - Prepares raw corpus inputs for preprocessing adapters without
      downloading large datasets to the local workstation.
"""
...
class AcquisitionSettings:
    """Normalized settings for the acquisition runner."""
...
class AcquisitionReport:
    """Deterministic machine-readable report for one acquisition pass."""
