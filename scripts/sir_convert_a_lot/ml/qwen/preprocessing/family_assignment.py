"""Manifest-family assignment helpers for the Qwen corpus pipeline.
...
Relationships:
    - Consumed by the preprocessing pipeline during curation.
    - Uses base models and families from `ml.qwen.common.models`.
"""

from __future__ import annotations

from scripts.sir_convert_a_lot.ml.qwen.common.models import ManifestFamily, SourceRecord
...
def manifest_target_for_source(source_record: SourceRecord) -> ManifestFamily | None:
    ...
    if source_record.dataset in {"repo_fixture_sv", "waxholm_fixture", "fleurs_fixture"}:
