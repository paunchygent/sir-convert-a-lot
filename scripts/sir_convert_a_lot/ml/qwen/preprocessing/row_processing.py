"""Row-processing stage for the Qwen Swedish preprocessing pipeline.
...
Relationships:
    ...
    - Consumes ASR policy from `ml.qwen.preprocessing.asr`.
    - Persists durable row results through `ml.qwen.preprocessing.storage`.
"""
...
def process_rows_to_spool(
    ...
    *,
    ...
    if settings.resume_row_processing:
        print(
            "[preprocessing-resume] loaded_completed_row_keys "
