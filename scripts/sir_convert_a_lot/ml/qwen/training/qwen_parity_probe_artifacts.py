"""Artifact and signature helpers for the Qwen stability lab parity probe.
...
Relationships:
    - Imported by `qwen_parity_probe_runtime.py` to build path reports.
    - Imported by `qwen_parity_probe_execution.py` to project execution
