"""Selected-row mini-bundle helpers for the Story 30 backward-lineage probe.
...
Relationships:
    - Used by `story30_backward_lineage_runner.py` before the container probe
      launches.
...
_SOURCE_FAMILY_FIELD = "story30_source_manifest_family"
...
def _resolve_source_bundle_root(*, source_bundle_root: Path, manifest_family: str) -> Path:
    """Resolve the canonical dated Task 101 bundle root when needed."""
...
def _validate_single_manifest_bundle(*, bundle_root: Path, manifest_family: str) -> None:
    """Validate the single-manifest mini-bundle contract for T212."""
