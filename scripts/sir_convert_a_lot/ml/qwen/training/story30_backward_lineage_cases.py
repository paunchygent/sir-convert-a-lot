"""Case sequencing and report assembly for Story 30 lineage probes.

Purpose:
    Own the deterministic row/loss probe order, branch interaction summaries,
    and report-building logic for Story 30 lineage work so execution modules do
...
def build_case_specs(source_line_numbers: tuple[int, int]) -> tuple[ProbeCaseSpec, ...]:
    """Return the fixed branch-ordered case sequence requested for Story 30."""
