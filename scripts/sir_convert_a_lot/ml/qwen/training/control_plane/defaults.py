...
from scripts.sir_convert_a_lot.ml.qwen.training.gradient_accumulation import (
    DEFAULT_GRADIENT_ACCUMULATION_STEPS as DEFAULT_GRADIENT_ACCUMULATION_STEPS_RUNTIME,
)
...
from scripts.sir_convert_a_lot.ml.qwen.training.text_embedding_assembly_mode import (
    DEFAULT_TEXT_EMBEDDING_ASSEMBLY_MODE as DEFAULT_TEXT_EMBEDDING_ASSEMBLY_MODE_RUNTIME,
)
...
DEFAULT_TEXT_EMBEDDING_ASSEMBLY_MODE = DEFAULT_TEXT_EMBEDDING_ASSEMBLY_MODE_RUNTIME
DEFAULT_TEXT_EMBEDDING_MASK_POLICY = DEFAULT_TEXT_EMBEDDING_MASK_POLICY_RUNTIME
DEFAULT_BATCH_SIZE = 8
DEFAULT_LR = 2e-5
DEFAULT_NUM_EPOCHS = 1
DEFAULT_MAX_STEPS = 8
DEFAULT_GRADIENT_ACCUMULATION_STEPS = DEFAULT_GRADIENT_ACCUMULATION_STEPS_RUNTIME
...
DEFAULT_CAPTURE_DIAGNOSTIC_STATE_TARGET_OPTIMIZER_STEP = 1401
