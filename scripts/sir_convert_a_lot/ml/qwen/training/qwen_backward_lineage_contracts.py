"""Contracts for Qwen backward-lineage and fresh-start proof lane backward-lineage and talker-core
probes.
...
Relationships:
    ...
    - Imported by `qwen_backward_lineage_cases.py` for branch summaries and
      report assembly.
"""
