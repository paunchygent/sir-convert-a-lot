"""Reporting types and rendering helpers for the Hemma OpenVoice benchmark.

Purpose:
    Keep the OpenVoice benchmark runner focused on orchestration while
...
Relationships:
    ...
    - Records evidence for `docs/backlog/tasks/...` under
      `build/verification/openvoice-v2-hemma/`.
"""
...
class BenchmarkReport:
    """Top-level JSON payload for OpenVoice Hemma evidence."""
...
def build_report_markdown(report: BenchmarkReport) -> str:
    """Render one operator-friendly markdown summary for OpenVoice benchmark evidence."""
