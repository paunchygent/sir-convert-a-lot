...
DEFAULT_OUTPUT_ROOT = Path("build/verification/qwen-docker-bind-roots-hemma-qwen-docker-bind-roots")
DEFAULT_PROBE_IMAGE = "sir-convert-a-lot-qwen-finetune-hemma:qwen-finetune"
