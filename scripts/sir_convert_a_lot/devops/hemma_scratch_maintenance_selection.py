...
Relationships:
    - Used by `hemma_scratch_maintenance_runtime.py` to decide which
      paths can be archived during one maintenance pass.
    - Reuses Hemma scratch audit archive-path and directory-size helpers.
"""
...
from scripts.sir_convert_a_lot.devops.hemma_scratch_maintenance_contracts import (
    ...
    PROTECTED_QWEN_FALLBACK_RCA_ROOT,
    PROTECTED_QWEN_PILOT_RUN_ROOT,
    CandidateParent,
