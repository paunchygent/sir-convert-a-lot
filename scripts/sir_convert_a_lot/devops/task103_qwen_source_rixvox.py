...
RixvoxBatchProgressCallback = Callable[[int, int], None]
RixvoxLocatorProgressCallback = Callable[[int, int], None]
...
def rixvox_source_records_from_parquet_with_audio_locators(
    ...
    *,
    ...
    batch_progress_callback: RixvoxBatchProgressCallback | None = None,
) -> list[SourceRecord]:
...
def build_rixvox_audio_locator_index(
    ...
    *,
    ...
    progress_callback: RixvoxLocatorProgressCallback | None = None,
