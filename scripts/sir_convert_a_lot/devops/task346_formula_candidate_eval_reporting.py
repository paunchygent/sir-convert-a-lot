"""Write Task 346 formula candidate evaluation reports.
...
Relationships:
    - Consumes candidate records from Task 346 candidate helpers.
    - Consumes source inputs from Task 346 input helpers.
...
def write_markdown_report(*, path: Path, payload: Mapping[str, object]) -> None:
    ...
    lines = [
        "# Task 346 formula candidate evaluation",
        "",
...
def render_visual_review_index(
    *,
    ...
    html_text = (
        ...
        "<title>Task 346 visual review</title>"
        ...
        "<body><h1>Task 346 visual review</h1>" + "".join(rows) + "</body></html>\n"
    )
