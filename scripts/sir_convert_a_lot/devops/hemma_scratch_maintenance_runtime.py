...
Relationships:
    - Used by `run_hemma_scratch_policy.py` for the `maintain`
      subcommand.
    - Delegates candidate policy to
      `hemma_scratch_maintenance_selection.py`.
    - Delegates timer behavior to `hemma_scratch_timer_runtime.py`.
    - Reuses Hemma scratch audit audit/archive primitives from
      `hemma_scratch_policy_runtime.py`.
"""
