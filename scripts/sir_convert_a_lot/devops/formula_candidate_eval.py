"""Evaluate formula/OCR candidates on established Docling page-window replay incident inputs.
...
Relationships:
    - Consumes Docling page-window replay page-window replay reports and rendered source pages.
    - Delegates input preparation, candidate execution, and report writing to
      formula candidate evaluation helper modules.
...
from scripts.sir_convert_a_lot.devops.formula_candidate_eval_candidates import (
    BAD_MARKERS,
    CandidateSpec,
    candidate_sources,
...
from scripts.sir_convert_a_lot.devops.formula_candidate_eval_reporting import (
    candidate_dicts,
...
DEFAULT_INPUT_ROOT = Path("build/verification/docling-md-review-20260605T112725Z")
DEFAULT_OUTPUT_ROOT = Path("build/verification/formula-candidate-eval")
DEFAULT_PAGES = "13-16"


def main(argv: Sequence[str] | None = None) -> int:
    """Run the formula candidate evaluation candidate evaluation CLI."""
...
def run_evaluation(*, args: argparse.Namespace, run_dir: Path) -> dict[str, object]:
    ...
    return {
        "schema_version": "formula_candidate_eval_v1",
        "run_id": run_dir.name,
...
def utc_run_id() -> str:
    ...
    return datetime.now(UTC).strftime("formula-candidate-eval-%Y%m%dT%H%M%SZ")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=os.environ.get("SIR_CONVERT_A_LOT_FORMULA_CANDIDATE_PADDLE_COMMAND"),
        help=(
    ...
    parser.add_argument(
        ...
        default=os.environ.get("SIR_CONVERT_A_LOT_FORMULA_CANDIDATE_DEEPSEEK_OCR2_COMMAND"),
        help=(
    ...
    parser.add_argument(
        ...
        default=os.environ.get("SIR_CONVERT_A_LOT_FORMULA_CANDIDATE_DEEPSEEK_OCR2_BATCH_COMMAND"),
        help=(
