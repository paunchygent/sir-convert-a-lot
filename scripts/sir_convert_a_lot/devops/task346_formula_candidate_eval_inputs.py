"""Prepare Task 346 source page and formula-crop evaluation inputs.

Purpose:
    Extract established Task 344 page/crop evidence and render local visual
    inputs for formula/OCR candidate evaluation.

Relationships:
    - Consumes Task 344 replay report metadata.
    - Reuses `render_pdf_bbox_crop` for crop images.
    - Feeds Task 346 candidate and reporting helpers.
"""
...
def harvest_formula_regions(
    ...
    *,
    ...
    """Extract formula crop metadata from a Task 344 replay report."""
