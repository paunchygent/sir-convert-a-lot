...
Relationships:
    - Used by `task205_hemma_scratch_maintenance_runtime.py` as the runtime
      orchestration contract.
    - Used by `task205_hemma_scratch_maintenance_selection.py` for candidate
      selection policy.
    - Used by `task205_hemma_scratch_timer_runtime.py` for systemd timer
...
DEFAULT_TIMER_OUTPUT_ROOT = Path("build/verification/task-205-hemma-scratch-maintenance")
