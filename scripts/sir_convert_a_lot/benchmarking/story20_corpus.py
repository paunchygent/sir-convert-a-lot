"""PDF corpus preparation for Task 74 benchmarks.
...
Relationships:
    - Used by `story20_profile_runner` to create local smoke corpus files.
    - Copies Task 270 private dirty-corpus inputs into sanitized filenames
      before benchmark execution.
    - Produces `CorpusFileRecord` entries embedded in Task 74 evidence payloads.
"""
...
from .story20_throughput_types import CorpusFileRecord, DirtyCorpusManifestSummary
