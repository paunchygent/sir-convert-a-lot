...
Purpose:
    Provide durable v2 job-state persistence and recovery for runtime orchestration,
    including binary output artifacts (PDF/DOCX) and optional auxiliary uploads
