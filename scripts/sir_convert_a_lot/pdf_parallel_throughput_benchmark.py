"""Benchmark parallel PDF throughput parallel PDF throughput evidence for PDF throughput lane.

Purpose:
    Execute a deterministic local benchmark that compares serial and bounded
    parallel PDF chunk processing using the real parallel PDF throughput executor path.
...
DEFAULT_OUTPUT_JSON = Path("build/benchmarks/pdf-throughput/pdf-parallel-throughput-local.json")
DEFAULT_DATA_ROOT = Path("build/benchmarks/pdf-throughput/pdf-parallel-throughput-runtime")
        ...
        *,
        ...
        return (
            ...
            ConversionMetadata(
                ...
                options_fingerprint="sha256:pdf-parallel-benchmark-stub",
            ),
            [],
...
def run_benchmark(
    *,
    ...
    """Run the deterministic parallel PDF throughput throughput benchmark and return the payload."""
    ...
    payload: BenchmarkPayload = {
        "benchmark_id": "pdf-parallel-throughput",
...
def main() -> None:
    """Parse CLI args and write parallel PDF throughput throughput benchmark evidence."""
    parser = argparse.ArgumentParser(
        description="Run parallel PDF throughput parallel throughput benchmark."
    )
