...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--diagnostic_source_launch_root", type=str, default=None)
    parser.add_argument("--diagnostic_source_checkpoint_path", type=str, default=None)
    parser.add_argument("--diagnostic_target_optimizer_step", type=int, default=None)
    parser.add_argument("--diagnostic_capture_artifact_path", type=str, default=None)
    parser.add_argument("--diagnostic_capture_launch_root_host_path", type=str, default=None)
    parser.add_argument("--diagnostic_capture_checkpoint_path", type=str, default=None)
